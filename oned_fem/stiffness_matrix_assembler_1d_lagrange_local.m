function stiffnessMatrixLocal = stiffness_matrix_assembler_1d_lagrange_local(aName, element, iDegree1, iDerivative1, ...
    iDegree2, iDerivative2, nGaussPoint)
%--------------------------------------------------------------------------
%stiffness_matrix_assembler_local:
...
for iShape1 = 1:(iDegree1+1)
    for iShape2 = 1:(iDegree2+1)
        integrand = feval(aName,gaussPoint).*shape_function_generator_1d_lagrange_local(gaussPoint,element,iDegree1,iDerivative1,iShape1).*...
