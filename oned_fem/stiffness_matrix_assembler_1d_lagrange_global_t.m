function stiffnessMatrixGlobal = stiffness_matrix_assembler_1d_lagrange_global_t(aName, Mesh, Fem1, ... 
    iDerivative1, Fem2, iDerivative2, nGaussPoint, t)
%--------------------------------------------------------------------------
%stiffness_matrix_assembler_lagrange_global_t:
...
for k = 1:size(Mesh.element,2)
    ...
    stiffnessMatrixLocal = stiffness_matrix_assembler_1d_lagrange_local_t(aName, elem, ...
