function loadVectorGlobal = load_vector_assembler_1d_lagrange_global(fName, Mesh, Fem, iDerivative, nGaussPoint)
%--------------------------------------------------------------------------
%load_vector_assembler_global:
...
for k = 1:size(Mesh.element,2)
    ...
    loadVectorLocal = load_vector_assembler_1d_lagrange_local(fName, element, iDegree, ...
