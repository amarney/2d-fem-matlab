function loadVectorLocal = load_vector_assembler_1d_lagrange_local(fName, element, iDegree, ...
iDerivative, nGaussPoint)
%--------------------------------------------------------------------------
%load_vector_assembler_local:
...
for iShape = 1:(iDegree+1)
    integrand = feval(fName,gaussPoint).*shape_function_generator_1d_lagrange_local(gaussPoint, ...
